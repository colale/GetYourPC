...
public class RequireBudgetGrController {
    ...
    @FXML
    void btnFirstRangeClick(MouseEvent event) {

    }

    @FXML
    void btnFourthRangeClick(MouseEvent event) {

    }

    @FXML
    void btnSecondRangeClick(MouseEvent event) {

    }

    @FXML
    void btnThirdRangeClick(MouseEvent event) {
